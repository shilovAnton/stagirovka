...
INSERT INTO INVENTORY_NUMBER (ID_BOOK, ARRIVAL_BOOK, WRITE_OFF_DATE_BOOK) VALUES (v_id_book, '02.04.1995', NULL);
INSERT INTO INVENTORY_NUMBER (ID_BOOK, ARRIVAL_BOOK, WRITE_OFF_DATE_BOOK) VALUES (v_id_book, '02.04.1995', NULL);
INSERT INTO INVENTORY_NUMBER (ID_BOOK, ARRIVAL_BOOK, WRIмTE_OFF_DATE_BOOK) VALUES (v_id_book, '02.04.1995', NULL);
INSERT INTO INVENTORY_NUMBER (ID_BOOK, ARRIVAL_BOOK, WRITE_OFF_DATE_BOOK) VALUES (v_id_book, '02.04.1995', NULL);
INSERT INTO INVENTORY_NUMBER (ID_BOOK, ARRIVAL_BOOK, WRITE_OFF_DATE_BOOK) VALUES (v_id_book, '02.04.1995', NULL);
INSERT INTO INVENTORY_NUMBER (ID_BOOK, ARRIVAL_BOOK, WRITE_OFF_DATE_BOOK) VALUES (v_id_book, '02.04.1995', NULL);
--------------------------------------------------------------------------------------------------------------------------
...
INSERT INTO LIBRARY_CARD (READERS_FIRSTNAME, READERS_LASTNAME, SUM_FINES, ID_ROLE, DATE_OF_BIRTH, DATE_OF_ISSUE_CARD, ID_READER_RATING, AGE_READERS) 
    VALUES ('Антон', 'Шилов', 0, 1, '2020/07/10', '2019/07/22', 5, TRUNC(MONTHS_BETWEEN(CURRENT_DATE,'1986/07/10') / 12));
INSERT INTO LIBRARY_CARD (READERS_FIRSTNAME, READERS_LASTNAME, SUM_FINES, ID_ROLE, DATE_OF_BIRTH, DATE_OF_ISSUE_CARD, ID_READER_RATING, AGE_READERS) 
    VALUES ('Сергей', 'Яхно', 0, 1, '2021/12/25', '2020/07/15', 2, TRUNC(MONTHS_BETWEEN(CURRENT_DATE,'1985/12/25') / 12));
INSERT INTO LIBRARY_CARD (READERS_FIRSTNAME, READERS_LASTNAME, SUM_FINES, ID_ROLE, DATE_OF_BIRTH, DATE_OF_ISSUE_CARD, ID_READER_RATING, AGE_READERS) 
    VALUES ('Павел', 'Струк', 0, 1, '1980/01/01', '2015/12/14', 3, TRUNC(MONTHS_BETWEEN(CURRENT_DATE,'1980/01/01') / 12));
INSERT INTO LIBRARY_CARD (READERS_FIRSTNAME, READERS_LASTNAME, SUM_FINES, ID_ROLE, DATE_OF_BIRTH, DATE_OF_ISSUE_CARD, ID_READER_RATING, AGE_READERS) 
    VALUES ('Анатолий', 'Вассерман', 100, 1, '1996/05/11', '2016/11/10', 4, TRUNC(MONTHS_BETWEEN(CURRENT_DATE,'1996/05/11') / 12));
INSERT INTO LIBRARY_CARD (READERS_FIRSTNAME, READERS_LASTNAME, SUM_FINES, ID_ROLE, DATE_OF_BIRTH, DATE_OF_ISSUE_CARD, ID_READER_RATING, AGE_READERS) 
    VALUES ('Наталья', 'Плотникова', 200, 1, '1982/03/01', '2021/10/26', 5, TRUNC(MONTHS_BETWEEN(CURRENT_DATE,'1982/03/01') / 12));
INSERT INTO LIBRARY_CARD (READERS_FIRSTNAME, READERS_LASTNAME, SUM_FINES, ID_ROLE, DATE_OF_BIRTH, DATE_OF_ISSUE_CARD, ID_READER_RATING, AGE_READERS) 
    VALUES ('Татьяна', 'Шилова', 0, 1, '2000/06/20', '2016/09/17', 1, TRUNC(MONTHS_BETWEEN(CURRENT_DATE,'2000/06/20') / 12));
INSERT INTO LIBRARY_CARD (READERS_FIRSTNAME, READERS_LASTNAME, SUM_FINES, ID_ROLE, DATE_OF_BIRTH, DATE_OF_ISSUE_CARD, ID_READER_RATING, AGE_READERS) 
    VALUES ('Марина', 'Гаврилова', 300, 1, '1985/07/10', '2019/07/18', 2, TRUNC(MONTHS_BETWEEN(CURRENT_DATE,'1985/07/10') / 12));
INSERT INTO LIBRARY_CARD (READERS_FIRSTNAME, READERS_LASTNAME, SUM_FINES, ID_ROLE, DATE_OF_BIRTH, DATE_OF_ISSUE_CARD, ID_READER_RATING, AGE_READERS) 
    VALUES ('Кирилл', 'Сайко', 0, 1, '1989/09/05', '2017/08/09', 3, TRUNC(MONTHS_BETWEEN(CURRENT_DATE,'1989/09/05') / 12));
INSERT INTO LIBRARY_CARD (READERS_FIRSTNAME, READERS_LASTNAME, SUM_FINES, ID_ROLE, DATE_OF_BIRTH, DATE_OF_ISSUE_CARD, ID_READER_RATING, AGE_READERS) 
    VALUES ('Виталий', 'Игнатьев', 0, 1, '1992/08/15', '2017/06/06', 4, TRUNC(MONTHS_BETWEEN(CURRENT_DATE,'1992/08/15') / 12));
INSERT INTO LIBRARY_CARD (READERS_FIRSTNAME, READERS_LASTNAME, SUM_FINES, ID_ROLE, DATE_OF_BIRTH, DATE_OF_ISSUE_CARD, ID_READER_RATING, AGE_READERS) 
    VALUES ('Алексей', 'Даль', 0, 1, '1993/11/26', '2019/05/05', 5, TRUNC(MONTHS_BETWEEN(CURRENT_DATE,'1993/11/26') / 12));
INSERT INTO LIBRARY_CARD (READERS_FIRSTNAME, READERS_LASTNAME, SUM_FINES, ID_ROLE, DATE_OF_BIRTH, DATE_OF_ISSUE_CARD, ID_READER_RATING, AGE_READERS) 
    VALUES ('Павел', 'Коврижных', 0, 1, '1995/02/09', '2018/04/01', 1, TRUNC(MONTHS_BETWEEN(CURRENT_DATE,'1995/02/09') / 12));
INSERT INTO LIBRARY_CARD (READERS_FIRSTNAME, READERS_LASTNAME, SUM_FINES, ID_ROLE, DATE_OF_BIRTH, DATE_OF_ISSUE_CARD, ID_READER_RATING, AGE_READERS) 
    VALUES ('Дмитрий', 'Лобанов', 0, 1, '1973/04/05', '2020/03/02', 2, TRUNC(MONTHS_BETWEEN(CURRENT_DATE,'1973/04/05') / 12));
INSERT INTO LIBRARY_CARD (READERS_FIRSTNAME, READERS_LASTNAME, SUM_FINES, ID_ROLE, DATE_OF_BIRTH, DATE_OF_ISSUE_CARD, ID_READER_RATING, AGE_READERS) 
    VALUES ('Александр', 'Горбатюк', 0, 2, '1956/06/21', '2020/02/03', 3, TRUNC(MONTHS_BETWEEN(CURRENT_DATE,'1956/06/21') / 12));
INSERT INTO LIBRARY_CARD (READERS_FIRSTNAME, READERS_LASTNAME, SUM_FINES, ID_ROLE, DATE_OF_BIRTH, DATE_OF_ISSUE_CARD, ID_READER_RATING, AGE_READERS) 
    VALUES ('Татьяна', 'Голикова', 0, 2, '1999/06/14', '2020/07/01', 4, TRUNC(MONTHS_BETWEEN(CURRENT_DATE,'1999/06/14') / 12));
INSERT INTO LIBRARY_CARD (READERS_FIRSTNAME, READERS_LASTNAME, SUM_FINES, ID_ROLE, DATE_OF_BIRTH, DATE_OF_ISSUE_CARD, ID_READER_RATING, AGE_READERS) 
    VALUES ('Екатерина', 'Симбирцева', 0, 2, '1978/12/11', '2021/12/09', 5, TRUNC(MONTHS_BETWEEN(CURRENT_DATE,'1978/12/11') / 12));
INSERT INTO LIBRARY_CARD (READERS_FIRSTNAME, READERS_LASTNAME, SUM_FINES, ID_ROLE, DATE_OF_BIRTH, DATE_OF_ISSUE_CARD, ID_READER_RATING, AGE_READERS) 
    VALUES ('Максим', 'Новицкий', 0, 2, '1988/04/22', '2020/11/10', 1, TRUNC(MONTHS_BETWEEN(CURRENT_DATE,'1988/04/22') / 12));
INSERT INTO LIBRARY_CARD (READERS_FIRSTNAME, READERS_LASTNAME, SUM_FINES, ID_ROLE, DATE_OF_BIRTH, DATE_OF_ISSUE_CARD, ID_READER_RATING, AGE_READERS) 
    VALUES ('Евгений', 'Максимов', 0, 2, '1987/08/12', '2019/10/15', 2, TRUNC(MONTHS_BETWEEN(CURRENT_DATE,'1987/08/12') / 12));
INSERT INTO LIBRARY_CARD (READERS_FIRSTNAME, READERS_LASTNAME, SUM_FINES, ID_ROLE, DATE_OF_BIRTH, DATE_OF_ISSUE_CARD, ID_READER_RATING, AGE_READERS) 
    VALUES ('Евгения', 'Алексеева', 0, 2, '1995/02/09', '2017/09/03', 3, TRUNC(MONTHS_BETWEEN(CURRENT_DATE,'1995/02/09') / 12));
INSERT INTO LIBRARY_CARD (READERS_FIRSTNAME, READERS_LASTNAME, SUM_FINES, ID_ROLE, DATE_OF_BIRTH, DATE_OF_ISSUE_CARD, ID_READER_RATING, AGE_READERS) 
    VALUES ('Дарья', 'Анохина', 0, 2, '1992/10/23', '2019/08/09', 4, TRUNC(MONTHS_BETWEEN(CURRENT_DATE,'1992/10/23') / 12));
INSERT INTO LIBRARY_CARD (READERS_FIRSTNAME, READERS_LASTNAME, SUM_FINES, ID_ROLE, DATE_OF_BIRTH, DATE_OF_ISSUE_CARD, ID_READER_RATING, AGE_READERS) 
    VALUES ('Дмитрий', 'Голуб', 0, 2, '1990/01/07', '2019/06/29', 1, TRUNC(MONTHS_BETWEEN(CURRENT_DATE,'1990/01/07') / 12));
